...
class CampaignsController extends Controller
{
    ...
    public function create()
    {
		...
		$user = request()->user();
        $fundraisers = FundRaiser::whereUserId($user->id)->orderBy('id', 'asc')->get();

        return view('admin.start_campaign', compact('title', 'categories', 'countries', 'fundraisers'));
    }
    ...
    public function store(Request $request) {
        ...
        $data = [
            'user_id'           => $user_id,
            'fund_raiser_id'    => $request->fundraiser,
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $countries = Country::all();
        $fundraisers = FundRaiser::whereUserId($user_id)->orderBy('id', 'asc')->get();

        return view('admin.edit_campaign', compact('title', 'categories', 'countries', 'campaign', 'fundraisers'));
    }
    ...
    public function paymentStripeReceive(Request $request){
        ...
        try {
            ...
            $charge = \Stripe\Charge::create(array(
                "amount"        => get_stripe_amount($amount, $currency), // amount in cents, again
                "currency"      => $currency,
                "source"        => $stripeToken,
            ...
            if ($charge->status == 'succeeded'){
                ...
                $data = [
                    'name' => session('cart.full_name'),
                    'email' => session('cart.email'),
                    'amount' => get_stripe_amount($charge->amount, $currency),
