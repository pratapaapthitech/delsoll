...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        if ( file_exists(base_path('.env')) ){
            ...
            $getfund_options = [];
            $getfund_options['currency_position'] = get_option('currency_position');
            $getfund_options['currency_sign'] = get_option('currency_sign');
            $getfundConfigOptions['getfund_option'] = (object) $getfund_options;
            config($getfundConfigOptions);
