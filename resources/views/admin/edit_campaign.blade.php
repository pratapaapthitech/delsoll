                    ...
                    <div class="row">
                        <div class="col-md-10 col-xs-12">
							...
							<div class="form-group">
                                <label for="category" class="col-sm-4 control-label">@lang('app.fundraiser') </label>
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="fundraiser">
                                        <option value="">@lang('app.select_a_fundraiser')</option>
                                        @foreach($fundraisers as $fundraiser)
                                            <option value="{{ $fundraiser->id }}" @if($campaign->fund_raiser_id == $fundraiser->id) selected="selected" @endif>{{ $fundraiser->fund_title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
