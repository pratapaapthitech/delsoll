...
Route::get('campaigns/campaign_status/{id}/{status}', ['as'=>'campaign_status', 'uses' => 'CampaignsController@statusChange']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
	...
	Route::group(['prefix'=>'my_fundraisers'], function() {
		Route::get('/', ['as'=>'my_fundraisers', 'uses' => 'FundraisersController@allFundraisers']);
		Route::get('start_fundraiser', ['as'=>'start_fundraiser', 'uses' => 'FundraisersController@create']);
		Route::post('start_fundraiser', ['uses' => 'FundraisersController@store']);
		Route::get('fundraiser_status/{id}/{status}', ['as'=>'fundraiser_status', 'uses' => 'FundraisersController@statusChange']);
		Route::get('fundraiser_delete/{id}', ['as'=>'fundraiser_delete', 'uses' => 'FundraisersController@deleteFundraisers']);
		Route::get('slider_image_delete/{id}', ['as'=>'slider_image_delete', 'uses' => 'FundraisersController@deleteSliderImage']);
		Route::get('edit_fundraiser/{id}', ['as'=>'edit_fundraiser', 'uses' => 'FundraisersController@edit']);
		Route::post('edit_fundraiser/{id}', [ 'uses' => 'FundraisersController@update']);
	});
    ...
    Route::group(['middleware' => 'admin'], function() {
		...
		Route::group(['prefix'=>'fundraisers'], function() {
			Route::get('all_fundraisers', ['as'=>'all_fundraisers', 'uses' => 'FundraisersController@allFundraisers']);
        });
    ...
    Route::group(['prefix'=>'u'], function(){
        ...
        //Withdrawals
        Route::get('withdrawal-preference-stripe', ['as'=>'withdrawal_preference_stripe',  'uses' => 'UserController@withdrawalPreferenceStripe']);
